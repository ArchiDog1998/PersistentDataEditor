...
namespace ComponentToolkit
{
    internal class GooVariableControl : GooHorizonalControlBase<IGH_Goo>
    {
        ...
        private void Owner_ObjectChanged(Grasshopper.Kernel.IGH_DocumentObject sender, Grasshopper.Kernel.GH_ObjectChangedEventArgs e)
        {
        ...
        protected override BaseControlItem[] SetControlItems()
        {
            if (_owner!= null && _owner.TypeHint != null)
            {
                ...
                else if (_owner.TypeHint is GH_DoubleHint_CS || _owner.TypeHint is GH_DoubleHint_VB)
                    return new BaseControlItem[]{
                ...
                else if (_owner.TypeHint is GH_IntegerHint_CS || _owner.TypeHint is GH_IntegerHint_VB)
                    return new BaseControlItem[]{
                        new GooIntegerControl(() => (GH_Integer)ShowValue, _isNull, null),
                    };
                else if (_owner.TypeHint is GH_IntervalHint)
                    return new BaseControlItem[]{
                        new GooIntervalControl(() => (GH_Interval)ShowValue, _isNull, null),
                    };
                else if (_owner.TypeHint is GH_LineHint)
                    return new BaseControlItem[]{
                ...
                else if (_owner.TypeHint is GH_PlaneHint)
                    return new BaseControlItem[]{
                        new GooPlaneControl(() => (GH_Plane)ShowValue, _isNull, null),
                    };
                else if (_owner.TypeHint is GH_Point3dHint)
                    return new BaseControlItem[]{
                        new GooPointControl(() => (GH_Point)ShowValue, _isNull, null),
                    };
                //else if (script.TypeHint is GH_PolylineHint)
                //    guid = new Param_Curve().ComponentGuid;
                else if (_owner.TypeHint is GH_Rectangle3dHint)
                    return new BaseControlItem[]{
                        new GooRectangleControl(() => (GH_Rectangle)ShowValue, _isNull, null),
                    };
                else if (_owner.TypeHint is GH_StringHint_CS || _owner.TypeHint is GH_StringHint_VB)
                    return new BaseControlItem[]{
                ...
                else if (_owner.TypeHint is GH_UVIntervalHint)
                    return new BaseControlItem[]{
                        new GooInterval2DControl(() => (GH_Interval2D)ShowValue, _isNull, null),
                    };
                else if (_owner.TypeHint is GH_Vector3dHint)
                    return new BaseControlItem[]{
